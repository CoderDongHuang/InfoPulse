...
# --- Routes ---
from app.api import action_loop, adaptive_intelligence, agent, analyses, auth, automation, autonomous_enterprise, cognitive_infrastructure, commercialization, contents, enterprise, events, global_coordination, global_intelligence, graph, history, hot_search, insights, knowledge, mouthpiece, multimodal, operations, operations_center, orchestration, personalization, planetary_resilience, platform, provable_autonomy, reports, search, sources, stage3, stage10, timeline, trusted_ecosystem  # noqa: E402
